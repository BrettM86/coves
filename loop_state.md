...
| 20 | Enforcement flip: audit counts → 0, warn → fail; docs (spec → CANONICAL, delete TESTING_SUMMARY.md + docs/E2E_TESTING.md, CLAUDE.md pointer) | 6 ⛩ | S | in-progress | | S not M — audit has real residue (sleeps/skips) + spec §3.4a/§3.7 refresh |
