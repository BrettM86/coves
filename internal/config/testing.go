...
var loadedEnvVars = []string{
	"IS_DEV_ENV",
	"DATABASE_URL",
	"DB_MAX_OPEN_CONNS", "DB_MAX_IDLE_CONNS", "DB_SESSION_COORDINATION_MAX_OPEN_CONNS", "DB_CONN_MAX_LIFETIME",
	...
	"PLC_DIRECTORY_URL", "IDENTITY_PLC_URL", "IDENTITY_CACHE_TTL", "HANDLE_WELL_KNOWN_HOSTS",
	"OAUTH_SEAL_SECRET", "ENCRYPTION_KEY", "APPVIEW_PUBLIC_URL",
	...
	"BRIDGED_VOTE_POLL_INTERVAL", "BRIDGED_VOTE_POLL_LOOKBACK", "BRIDGED_VOTE_POLL_SWEEP_CAP",
	"PDS_URL", "PDS_INSTANCE_HANDLE", "PDS_INSTANCE_PASSWORD", "PDS_ADMIN_PASSWORD",
	"JETSTREAM_FEEDS", "REDRIVE_INTERVAL", "IDENTITY_NEGATIVE_CACHE_TTL",
	"CURSOR_SECRET",
	...
	"IMAGE_PROXY_MAX_SOURCE_SIZE_MB", "IMAGE_PROXY_MAX_SOURCE_MEGAPIXELS",
	"IMAGE_PROXY_MAX_CONCURRENT_PROCESSES", "IMAGE_PROXY_MAX_IN_FLIGHT_REQUESTS",
